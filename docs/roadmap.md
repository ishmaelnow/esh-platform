...
5. **Dispatch and Trip Core**
   ...
   - Current delivery: permanent pickup/destination geocoding with atomic Rider booking persistence,
     embedded Admin/Driver/Rider maps, traffic-aware road routes, live Driver markers, distance/ETA,
     privacy enforcement, and graceful mapping-provider fallback.

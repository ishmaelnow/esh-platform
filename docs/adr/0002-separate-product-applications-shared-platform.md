...
final combined operating experience. They remain until separate deployments and session enforcement
are production-verified, then `admin.eshapp.com` is reduced to governance only.

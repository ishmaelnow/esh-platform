...
| `NEXT_PUBLIC_COMMUNITY_ADMIN_URL`      | Community Administration entry        | Admin and Community Admin `.env.local` | Admin, Community Admin                     | Independent Community Administration origin.                                                                           |

...
Expected future applications may include web consoles, customer portals, operational dashboards, or mobile clients. Add those only when product scope requires them.
